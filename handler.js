...
// ==================== STORAGE ====================
const messageStore = new Map();          // anti-delete (memory only)
...
async function handleWelcome(conn, participant, groupJid, action = 'add') {
    ...
    // Important: group link is plain, not passed through fancy()
    ...
    // Header and borders can be fancy, but the link inside bodyPlain is untouched.
