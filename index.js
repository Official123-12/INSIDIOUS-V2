...
// FINAL VERSION – 100% READY FOR PTERODACTYL
// Developer: STANYTZ | Version: 2.2.3
...
const app = express();
const PORT = process.env.PORT || 3000; // Pterodactyl itatoa PORT yenyewe
...
// ✅ **CREATE PUBLIC FOLDER IF NOT EXISTS** – fixes the "public" error
...
// ✅ **DEPLOY ENDPOINT** – activate a session
...
app.get('/botinfo', (req, res) => {
    if (activeSockets.size === 0) {
        return res.json({ success: false, error: "No active bot sessions", connected: false });
    }
    res.json({
        success: true,
        activeSessions: activeSockets.size,
...
const server = app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(fancy("📅 Version: 2.2.3 | FINAL READY"));
});
