...
// Original style – updated with multi‑session, WhatsApp session ID, full API
// All requested features added: multi‑user, session ID in welcome message,
// deploy endpoint, sessions list, delete, settings, and automatic recovery.
...
// ✅ **CREATE PUBLIC FOLDER IF NOT EXISTS** (fixes "cannot read properties of undefined")
...
// ✅ **PAIRING ENDPOINT** – returns 8-digit code and sessionId
...
// ✅ **DEPLOY ENDPOINT** – activate a session (ensure socket is running)
...
// ✅ **BOT INFO ENDPOINT** – aggregate info (updated)
